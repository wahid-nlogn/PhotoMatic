...
public class UCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        EventBus.getDefault().post(new UCropEvent(UCropEvent.UCROP_ACTIVITY_LAUNCHED));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_crop) {
            EventBus.getDefault().post(new UCropEvent(UCropEvent.UCROP_NEXT_CLICKED));
            cropAndSaveImage();
        } else if (item.getItemId() == android.R.id.home) {
            //onBackPressed();
            showDiscardAlert(this);
        }
    ...
    public void onBackPressed() {
       // super.onBackPressed();
        //overridePendingTransition(R.anim.ucrop_slide_from_top,R.anim.ucrop_slide_in_top);
        showDiscardAlert(this);
    }

    private void showDiscardAlert(Context context) {

        String alertMessage = "Do you want to discard this project ?";
        String discard = "Discard";
        String cancel = "Cancel";

        AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(this, R.style.ucrop_AlertDialogTheme));
