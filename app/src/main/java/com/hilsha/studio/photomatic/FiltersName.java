...
public class FiltersName {
    ...
    public List<String> mapofFilters=new ArrayList<String>();

    FiltersName(){
        insertData();
    }
    public  void  insertData(){
        mapofFilters.add("None");
        mapofFilters.add("Florance");
        mapofFilters.add("Vienna");
        mapofFilters.add("Edinburgh");
        mapofFilters.add("Prague");
        mapofFilters.add("Moscow");
        mapofFilters.add("Bruges");
        mapofFilters.add("Verona");
        mapofFilters.add("Annecy");
        mapofFilters.add("Budapest");
        mapofFilters.add("Barcelona");
    }

    public  List<String> getMapofFilters() {
        return mapofFilters;
    }
